...
{*
	<a class="hidden-md-up" href="{$urls.pages.my_account}" title="{l s='View my customer account' d='Shop.Theme.Customeraccount'}" rel="nofollow">
...
*}
	...
	<ul class="user_info hidden-md-up">
		...
		{if $logged}
			...
			<li><a href="{$urls.pages.my_account}" title="{l s='View my customer account' d='Shop.Theme.Customeraccount'}" rel="nofollow">{l s='Your account' d='Shop.Theme.Customeraccount'}</a></li>

			<li><a id="identity-link" href="{$urls.pages.identity}">{l s='Your personal information' d='Shop.Theme.Customeraccount'}</a></li>
			...
			<li><a href="{$urls.actions.logout}" rel="nofollow">({l s='Sign out' d='Shop.Theme.Actions'})</a></li>
	...
	<div class="hidden-sm-down">
		...
		{else}
			<a class="account" href="{$urls.pages.my_account}" title="{l s='Log in to your customer account' d='Shop.Theme.Customeraccount'}" rel="nofollow">{l s='Sign in' d='Shop.Theme.Actions'}</a>
