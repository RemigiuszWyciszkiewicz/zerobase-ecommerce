			...
			<div class="header">
				...
				<div class="cart_index_title">
					<a class="cart_link" rel="nofollow" href="{$cart_url}">
						...
						<span class="cart-products-count">
							...
							<span class="cart_total">{$cart.subtotals.products.value}</span>
						</span>
					</a>
				</div>
				...
				*}
					...
					<div class="cart-buttons">
						<a class="btn btn-primary viewcart" rel="nofollow" href="{$cart_url}">{l s='Check Out' d='Shop.Theme.Mytheme'} <i class="material-icons">&#xE315;</i></a>
						{* <a class="btn btn-primary checkout" rel="nofollow" href="{$urls.pages.order}">{l s='Check Out' d='Shop.Theme.Mytheme'}</a> *}
					</div>
