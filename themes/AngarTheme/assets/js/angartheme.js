...
/* HOME TABS */
$(document).ready(function () {
  $("#home-page-tabs li:first a, #index .tab-content .tab-pane:first").addClass(
    "active in"
  );
});
...
$(document).on(
  "click",
  ".product_tabs1 .comments_advices .reviews",
  function (e) {
...
$(document).on(
  "click",
  ".product_tabs2 .comments_advices .reviews",
  function (e) {
    $("html, body").animate(
      {
        scrollTop: $(
          ".product_tabs2 #productCommentsBlock .index_title"
        ).offset().top,
      },
      500
    );
...
$(document).ready(function () {
  ...
  if (navigator.userAgent.match(/Android/i)) {
    ...
    viewport.setAttribute(
      "content",
      "initial-scale=1.0,maximum-scale=4.0,user-scalable=1,width=device-width,height=device-height"
    );
    window.scrollTo(0, 1);
  }
});
...
function accordion(status) {
  if (status == "enable") {
    var accordion_selector =
      ".columns .h6.text-uppercase, .columns .title_block";
...
$(document).ready(function () {
  $(".show_list").click(function () {
    ...
    document.cookie =
      "show_grid=; expires=Thu, 30 Jan 1970 12:00:00 UTC; path=/";
  ...
  $(".show_grid").click(function () {
    ...
    document.cookie =
      "show_grid=true; expires=Thu, 30 Jan 2100 12:00:00 UTC; path=/";
