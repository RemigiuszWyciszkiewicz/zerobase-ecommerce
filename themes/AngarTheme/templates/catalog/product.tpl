        ...
        <div class="col-md-6 product_right">
          {block name='page_header_container'}
            {block name='page_header'}
              <h1 class="product_name">{block name='page_title'}{$product.name}{/block}</h1>
            {/block}
          {/block}
          ...
          <div class="product-information">
			...
			{if $product.description_short}
              <div id="product-description-short-{$product.id}" class="product_desc">{$product.description_short nofilter}</div>
			{/if}
            {/block}
            ...
            <div class="product-actions">
              {block name='product_buy'}
                <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                  ...
                  {block name='product_discount_countdown'}
                    {include file='catalog/_partials/product-discount-countdown.tpl'}
                  {/block}
