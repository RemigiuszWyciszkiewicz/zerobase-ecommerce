...
<li class="brand col-xs-12 col-sm-4 col-md-3">
	<div class="brand-block">
		<div class="brand-img">
			...
			{if $smarty.const._PS_VERSION_ >= '9.0'}
				<picture>
				  ...
				  <img
					src="{$brand.image.bySize.small_default.url|replace:'-small_default':''|replace:'-default':''}"
			...
			{else}
				<img src="{$brand.image|replace:'-small_default':''|replace:'-default':''}" alt="{$brand.name}">
			{/if}
		</div>
