      ...
      <div class="modal-body">
        ...
        <figure>
		  ...
		  {if !empty($product.cover.bySize.home_default.url)}
			<img class="js-modal-product-cover product-cover-modal" width="{$product.cover.large.width}" src="{if !empty($product.default_image.bySize.large_default.url)}{$product.default_image.bySize.large_default.url}{else}{$product.cover.bySize.large_default.url}{/if}" alt="{$product.cover.legend}" title="{$product.cover.legend}">
		  {else}
			<img class="js-modal-product-cover product-cover-modal" src="{$urls.img_url}en-default-large_default.jpg">
		  {/if}
          {if $imagesCount > 1}
          ...
          {block name='product_description_short'}
            {if $product.description_short}<div id="product-description-short">{$product.description_short nofilter}</div>{/if}
          {/block}
          </figcaption>
        </figure>
