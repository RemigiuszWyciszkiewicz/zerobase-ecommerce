					...
					<div class="cat-container">
						...
						<div class="catlinks_container">
							<div class="homecat_name">
								<a href="{$link->getCategoryLink({$catProduct.id|escape:'htmlall':'UTF-8'},{$catProduct.link_rewrite})|escape:'html':'UTF-8'}">
							...
							{if $show_btn == 1}
								<a class="view_more" href="{$link->getCategoryLink({$catProduct.id|escape:'htmlall':'UTF-8'},{$catProduct.link_rewrite})|escape:'html':'UTF-8'}">
								  {l s='See more' mod='angarhomecat'}
								  <span class="sr-only">{$catProduct.name|escape:'htmlall':'UTF-8'}</span>
								</a>
							{/if}
						</div>
