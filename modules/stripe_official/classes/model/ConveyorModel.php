...
class ConveyorModel
{
    ...
    {
        $amount = in_array(Tools::strtolower($this->currencyIso), ['ugx', 'isk']) ? $amount * 100 : (Stripe_official::isZeroDecimalCurrency(Tools::strtoupper($this->currencyIso)) && in_array(Tools::strtolower($this->currencyIso), ['ugx']) ? $amount : $amount / 100);
        $this->amount = $amount;
    }
