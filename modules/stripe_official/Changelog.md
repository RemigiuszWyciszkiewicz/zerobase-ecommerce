...
## 3.6.8 - 2025-10-15
- Compatibility with Prestashop 1.7.4 (CONNECTORS-1960)

## 3.6.7 - 2025-10-08
- Resolved some issues flagged by Prestashop validator (CONNECTORS-1317)
- Handle webhook requests in case of multistore setup with different stripe accounts (CONNECTORS-1867)
- Improvements on payments with zero decimal currencies (CONNECTORS-1566)

## 3.6.6 - 2025-09-17

_FIXED_ Collapse the Payment Element when Stripe is the only payment option available (CONNECTORS-1743)
