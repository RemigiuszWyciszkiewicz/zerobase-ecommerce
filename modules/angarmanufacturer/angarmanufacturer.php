...
class AngarManufacturer extends Module
{
    ...
    public function install()
    {
        return parent::install()
            ...
            && Configuration::updateValue('AT_MANUFACTURER_MAX', '5')
            && Configuration::updateValue('AT_MANUFACTURER_WIDTH', '234')
    ...
    public function uninstall()
    {
        ...
        && Configuration::deleteByName('AT_MANUFACTURER_MAX')
        && Configuration::deleteByName('AT_MANUFACTURER_WIDTH')
        && parent::uninstall();
    }
    ...
    public function hookAngarManufacturer($params)
    {
        ...
        foreach ($manuArray as $id_manufacturer) {
			...
			if (version_compare(_PS_VERSION_, '8.2', '<')) {
    ...
    public function hookDisplayBeforeBodyClosingTag($params)
    {
        $this->smarty->assign(array(
            ...
            'man_max' => Configuration::get('AT_MANUFACTURER_MAX'),
            'man_width' => Configuration::get('AT_MANUFACTURER_WIDTH')
        ));
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitModule')) {
            ...
            Configuration::updateValue('AT_MANUFACTURER_MAX', Tools::getValue('at_manufacturer_max'));
            Configuration::updateValue('AT_MANUFACTURER_WIDTH', Tools::getValue('at_manufacturer_width'));
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'text',
                        'class'    => 'fixed-width-xxl',
                        'label' => $this->l('Number of manufacturers displayed:'),
                        'name' => 'at_manufacturer_max',
                    ),

                    array(
                        'type' => 'text',
                        'class'    => 'fixed-width-xxl',
                        'label' => $this->l('Manufacturer logo width:'),
                        'name' => 'at_manufacturer_width',
                    ),
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            'at_manufacturer_max' => Tools::getValue('at_manufacturer_max', Configuration::get('AT_MANUFACTURER_MAX')),
            'at_manufacturer_width' => Tools::getValue('at_manufacturer_width', Configuration::get('AT_MANUFACTURER_WIDTH')),
        );
    }
}
