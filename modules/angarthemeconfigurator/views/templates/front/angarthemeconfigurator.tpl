...
<div class="theme_customization_header">{l s='Theme layout editor' mod='angarthemeconfigurator'}</div>
...
<div class="panel">
	...
	<div class="main_font">
		<label class="options_title">{l s='Main font:' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Poppins"><input type="radio" name="angarconfig_input59" value="Poppins" {if $css59 == Poppins}checked{/if}>{l s='Poppins' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Open_Sans"><input type="radio" name="angarconfig_input59" value="Open_Sans" {if $css59 == Open_Sans}checked{/if}>{l s='Open Sans' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Roboto"><input type="radio" name="angarconfig_input59" value="Roboto" {if $css59 == Roboto}checked{/if}>{l s='Roboto' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Lato"><input type="radio" name="angarconfig_input59" value="Lato" {if $css59 == Lato}checked{/if}>{l s='Lato' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Raleway"><input type="radio" name="angarconfig_input59" value="Raleway" {if $css59 == Raleway}checked{/if}>{l s='Raleway' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Montserrat"><input type="radio" name="angarconfig_input59" value="Montserrat" {if $css59 == Montserrat}checked{/if}>{l s='Montserrat' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Bitter"><input type="radio" name="angarconfig_input59" value="Bitter" {if $css59 == Bitter}checked{/if}>{l s='Bitter' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Oswald"><input type="radio" name="angarconfig_input59" value="Oswald" {if $css59 == Oswald}checked{/if}>{l s='Oswald' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Dosis"><input type="radio" name="angarconfig_input59" value="Dosis" {if $css59 == Dosis}checked{/if}>{l s='Dosis' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Nunito"><input type="radio" name="angarconfig_input59" value="Nunito" {if $css59 == Nunito}checked{/if}>{l s='Nunito' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Muli"><input type="radio" name="angarconfig_input59" value="Muli" {if $css59 == Muli}checked{/if}>{l s='Muli' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Gothic_A1"><input type="radio" name="angarconfig_input59" value="Gothic_A1" {if $css59 == Gothic_A1}checked{/if}>{l s='Gothic A1' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Fira_Sans"><input type="radio" name="angarconfig_input59" value="Fira_Sans" {if $css59 == Fira_Sans}checked{/if}>{l s='Fira Sans' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Ubuntu"><input type="radio" name="angarconfig_input59" value="Ubuntu" {if $css59 == Ubuntu}checked{/if}>{l s='Ubuntu' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Lora"><input type="radio" name="angarconfig_input59" value="Lora" {if $css59 == Lora}checked{/if}>{l s='Lora' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Work_Sans"><input type="radio" name="angarconfig_input59" value="Work_Sans" {if $css59 == Work_Sans}checked{/if}>{l s='Work Sans' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Merriweather"><input type="radio" name="angarconfig_input59" value="Merriweather" {if $css59 == Merriweather}checked{/if}>{l s='Merriweather' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Playfair_Display"><input type="radio" name="angarconfig_input59" value="Playfair_Display" {if $css59 == Playfair_Display}checked{/if}>{l s='Playfair Display' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Playfair_Display_SC"><input type="radio" name="angarconfig_input59" value="Playfair_Display_SC" {if $css59 == Playfair_Display_SC}checked{/if}>{l s='Playfair Display SC' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Noto_Sans"><input type="radio" name="angarconfig_input59" value="Noto_Sans" {if $css59 == Noto_Sans}checked{/if}>{l s='Noto Sans' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Noto_Serif"><input type="radio" name="angarconfig_input59" value="Noto_Serif" {if $css59 == Noto_Serif}checked{/if}>{l s='Noto Serif' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Roboto_Slab"><input type="radio" name="angarconfig_input59" value="Roboto_Slab" {if $css59 == Roboto_Slab}checked{/if}>{l s='Roboto Slab' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Arimo"><input type="radio" name="angarconfig_input59" value="Arimo" {if $css59 == Arimo}checked{/if}>{l s='Arimo' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Cabin"><input type="radio" name="angarconfig_input59" value="Cabin" {if $css59 == Cabin}checked{/if}>{l s='Cabin' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Titillium_Web"><input type="radio" name="angarconfig_input59" value="Titillium_Web" {if $css59 == Titillium_Web}checked{/if}>{l s='Titillium Web' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Source_Sans_Pro"><input type="radio" name="angarconfig_input59" value="Source_Sans_Pro" {if $css59 == Source_Sans_Pro}checked{/if}>{l s='Source Sans Pro' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_PT_Sans"><input type="radio" name="angarconfig_input59" value="PT_Sans" {if $css59 == PT_Sans}checked{/if}>{l s='PT Sans' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Oxygen"><input type="radio" name="angarconfig_input59" value="Oxygen" {if $css59 == Oxygen}checked{/if}>{l s='Oxygen' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Quicksand"><input type="radio" name="angarconfig_input59" value="Quicksand" {if $css59 == Quicksand}checked{/if}>{l s='Quicksand' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Karla"><input type="radio" name="angarconfig_input59" value="Karla" {if $css59 == Karla}checked{/if}>{l s='Karla' mod='angarthemeconfigurator'}</label></br>
		<label class="mainfont_Comfortaa"><input type="radio" name="angarconfig_input59" value="Comfortaa" {if $css59 == Comfortaa}checked{/if}>{l s='Comfortaa' mod='angarthemeconfigurator'}</label></br>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box2">{l s='Top' mod='angarthemeconfigurator'}</div>
	<div id="customization_box2" class="collapse customization_container">	
		...
		<div class="nav_uppercase ver_270">
			<label class="options_title">{l s='Capitalize text in the top bar:' mod='angarthemeconfigurator'}</label></br>
			<label class="nav_uppercase_yes"><input type="radio" name="angarconfig_input79" value="nav_uppercase_yes" {if $css79 == nav_uppercase_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="nav_uppercase_no"><input type="radio" name="angarconfig_input79" value="nav_uppercase_no" {if $css79 == nav_uppercase_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box4">{l s='Logo' mod='angarthemeconfigurator'}</div>
	<div id="customization_box4" class="collapse customization_container">
		...
		<div class="logo_center ver_270">
			<label class="options_title">{l s='Center logo in the header:' mod='angarthemeconfigurator'}</label></br>
			<label class="logo_center_yes"><input type="radio" name="angarconfig_input80" value="logo_center_yes" {if $css80 == logo_center_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="logo_center_no"><input type="radio" name="angarconfig_input80" value="logo_center_no" {if $css80 == logo_center_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box21">{l s='Search bar' mod='angarthemeconfigurator'}</div>
	<div id="customization_box21" class="collapse customization_container">	

		<div class="search_style ver_270">
			<label class="options_title">{l s='Search bar style:' mod='angarthemeconfigurator'}</label></br>
			<label class="search_style_1"><input type="radio" name="angarconfig_input81" value="search_style_1" {if $css81 == search_style_1}checked{/if}>{l s='Search style 1' mod='angarthemeconfigurator'}</label>
			<label class="search_style_2"><input type="radio" name="angarconfig_input81" value="search_style_2" {if $css81 == search_style_2}checked{/if}>{l s='Search style 2' mod='angarthemeconfigurator'}</label>	 
		</div>

		<div id="search_border_radius">
			<div class="options_title ver_270">{l s='Search bar border radius:' mod='angarthemeconfigurator'} <span class="value">{$css82|escape:'htmlall':'UTF-8'}</span> <span>px</span></div>
			<input type="range" name="angarconfig_input82" min="0" max="20" value="{$css82|escape:'htmlall':'UTF-8'}">
		</div>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box5">{l s='Cart' mod='angarthemeconfigurator'}</div>
	<div id="customization_box5" class="collapse customization_container">	
		...
		<div class="cart_style ver_270">
			...
			<label class="cart_style_1"><input type="radio" name="angarconfig_input62" value="cart_style_1" {if $css62 == cart_style_1}checked{/if}>{l s='Cart style 1' mod='angarthemeconfigurator'}</label>
			<label class="cart_style_2"><input type="radio" name="angarconfig_input62" value="cart_style_2" {if $css62 == cart_style_2}checked{/if}>{l s='Cart style 2' mod='angarthemeconfigurator'}</label>
			<label class="cart_style_3"><input type="radio" name="angarconfig_input62" value="cart_style_3" {if $css62 == cart_style_3}checked{/if}>{l s='Cart style 3' mod='angarthemeconfigurator'}</label>	 
		</div>

		<div id="cart_border_radius">
			<div class="options_title ver_270">{l s='Cart border radius:' mod='angarthemeconfigurator'} <span class="value">{$css83|escape:'htmlall':'UTF-8'}</span> <span>px</span></div>
			<input type="range" name="angarconfig_input83" min="0" max="20" value="{$css83|escape:'htmlall':'UTF-8'}">
		</div>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box6">{l s='Menu' mod='angarthemeconfigurator'}</div>
	<div id="customization_box6" class="collapse customization_container">	

		<div class="menu_center ver_270">
			<label class="options_title">{l s='Center links in the menu:' mod='angarthemeconfigurator'}</label></br>
			<label class="menu_center_yes"><input type="radio" name="angarconfig_input84" value="menu_center_yes" {if $css84 == menu_center_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="menu_center_no"><input type="radio" name="angarconfig_input84" value="menu_center_no" {if $css84 == menu_center_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="menu_uppercase ver_270">
			<label class="options_title">{l s='Capitalize text in the menu:' mod='angarthemeconfigurator'}</label></br>
			<label class="menu_uppercase_yes"><input type="radio" name="angarconfig_input85" value="menu_uppercase_yes" {if $css85 == menu_uppercase_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="menu_uppercase_no"><input type="radio" name="angarconfig_input85" value="menu_uppercase_no" {if $css85 == menu_uppercase_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="submenu_uppercase ver_270">
			<label class="options_title">{l s='Capitalize text in the submenu:' mod='angarthemeconfigurator'}</label></br>
			<label class="submenu_uppercase_yes"><input type="radio" name="angarconfig_input86" value="submenu_uppercase_yes" {if $css86 == submenu_uppercase_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="submenu_uppercase_no"><input type="radio" name="angarconfig_input86" value="submenu_uppercase_no" {if $css86 == submenu_uppercase_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
	...
	<div id="customization_box7" class="collapse customization_container">	
		...
		<div class="slider_position">
			<label class="options_title">{l s='Slider position:' mod='angarthemeconfigurator'}</label></br>
		...
		<div class="slider_size">
			<label class="options_title">{l s='Slider width:' mod='angarthemeconfigurator'}</label></br>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box24">{l s='Left column' mod='angarthemeconfigurator'}</div>
	<div id="customization_box24" class="collapse customization_container">

		<div class="lc_index ver_270">
			<label class="options_title">{l s='Hide left column on the home page:' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_index_hide_yes"><input type="radio" name="angarconfig_input87" value="lc_index_hide_yes" {if $css87 == lc_index_hide_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_index_hide_no"><input type="radio" name="angarconfig_input87" value="lc_index_hide_no" {if $css87 == lc_index_hide_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="lc_category ver_270">
			<label class="options_title">{l s='Hide left column on the category page:' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_category_hide_yes"><input type="radio" name="angarconfig_input88" value="lc_category_hide_yes" {if $css88 == lc_category_hide_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_category_hide_no"><input type="radio" name="angarconfig_input88" value="lc_category_hide_no" {if $css88 == lc_category_hide_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="lc_product ver_270">
			<label class="options_title">{l s='Hide left column on the product page:' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_product_hide_yes"><input type="radio" name="angarconfig_input89" value="lc_product_hide_yes" {if $css89 == lc_product_hide_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_product_hide_no"><input type="radio" name="angarconfig_input89" value="lc_product_hide_no" {if $css89 == lc_product_hide_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="lc_cms ver_270">
			<label class="options_title">{l s='Hide left column on the cms page:' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_cms_hide_yes"><input type="radio" name="angarconfig_input90" value="lc_cms_hide_yes" {if $css90 == lc_cms_hide_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_cms_hide_no"><input type="radio" name="angarconfig_input90" value="lc_cms_hide_no" {if $css90 == lc_cms_hide_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="lc_width ver_270">
			<label class="options_title">{l s='Left column width on the computer:' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_width_25"><input type="radio" name="angarconfig_input91" value="lc_width_25" {if $css91 == lc_width_25}checked{/if}>{l s='Left column width 25%' mod='angarthemeconfigurator'}</label>
			<label class="lc_width_22"><input type="radio" name="angarconfig_input91" value="lc_width_22" {if $css91 == lc_width_22}checked{/if}>{l s='Left column width 22%' mod='angarthemeconfigurator'}</label>
			<label class="lc_width_20"><input type="radio" name="angarconfig_input91" value="lc_width_20" {if $css91 == lc_width_20}checked{/if}>{l s='Left column width 20%' mod='angarthemeconfigurator'}</label>
			<label class="lc_width_18"><input type="radio" name="angarconfig_input91" value="lc_width_18" {if $css91 == lc_width_18}checked{/if}>{l s='Left column width 18%' mod='angarthemeconfigurator'}</label>
			<label class="lc_width_15"><input type="radio" name="angarconfig_input91" value="lc_width_15" {if $css91 == lc_width_15}checked{/if}>{l s='Left column width 15%' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="lc_category ver_270">
			<label class="options_title">{l s='Category tree display style:' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_category_style_1"><input type="radio" name="angarconfig_input92" value="lc_category_style_1" {if $css92 == lc_category_style_1}checked{/if}>{l s='Style 1 (default) - Subcategories are collapsed' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_category_style_2"><input type="radio" name="angarconfig_input92" value="lc_category_style_2" {if $css92 == lc_category_style_2}checked{/if}>{l s='Style 2 - 1st-level subcategories are expanded' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_category_style_3"><input type="radio" name="angarconfig_input92" value="lc_category_style_3" {if $css92 == lc_category_style_3}checked{/if}>{l s='Style 3 - 1st- and 2nd-level subcategories are expanded' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_category_style_4"><input type="radio" name="angarconfig_input92" value="lc_category_style_4" {if $css92 == lc_category_style_4}checked{/if}>{l s='Style 4 - All subcategories are expanded' mod='angarthemeconfigurator'}</label></br>
		</div>

		<div class="lc_banner ver_270">
			<label class="options_title">{l s='Hide banners in the left column on mobile:' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_banner_hide_yes"><input type="radio" name="angarconfig_input93" value="lc_banner_hide_yes" {if $css93 == lc_banner_hide_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="lc_banner_hide_no"><input type="radio" name="angarconfig_input93" value="lc_banner_hide_no" {if $css93 == lc_banner_hide_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box14">{l s='Product-list options' mod='angarthemeconfigurator'}</div>
	<div id="customization_box14" class="collapse customization_container">
		...
		<div class="pl_gallery_type">
			<label class="options_title">{l s='Gallery type in the product-list:' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_gallery_type_1"><input type="radio" name="angarconfig_input78" value="pl_gallery_type_1" {if $css78 == pl_gallery_type_1}checked{/if}>{l s='Standard - display static image' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_gallery_type_2"><input type="radio" name="angarconfig_input78" value="pl_gallery_type_2" {if $css78 == pl_gallery_type_2}checked{/if}>{l s='Rollover - display second image on hover' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_gallery_type_3"><input type="radio" name="angarconfig_input78" value="pl_gallery_type_3" {if $css78 == pl_gallery_type_3}checked{/if}>{l s='Hover image slider - display all images on hover' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="pl_align ver_270">
			<label class="options_title">{l s='Product-list - align:' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_align_left"><input type="radio" name="angarconfig_input94" value="pl_align_left" {if $css94 == pl_align_left}checked{/if}>{l s='Left' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_align_center"><input type="radio" name="angarconfig_input94" value="pl_align_center" {if $css94 == pl_align_center}checked{/if}>{l s='Center' mod='angarthemeconfigurator'}</label>
		</div>
		...
		<div class="pl_name_uppercase">
			<label class="options_title">{l s='Product name - capitalize text:' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_name_uppercase_yes"><input type="radio" name="angarconfig_input95" value="pl_name_uppercase_yes" {if $css95 == pl_name_uppercase_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_name_uppercase_no"><input type="radio" name="angarconfig_input95" value="pl_name_uppercase_no" {if $css95 == pl_name_uppercase_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
		...
		<div class="pl_qty">
			<label class="options_title">{l s='Hide quantity field in the product-list:' mod='angarthemeconfigurator'}</label></br>
		...
		<div class="pl_grayout">
			<label class="options_title">{l s='Gray out unavailable products in the product-list:' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_grayout_yes"><input type="radio" name="angarconfig_input77" value="pl_grayout_yes" {if $css77 == pl_grayout_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_grayout_no"><input type="radio" name="angarconfig_input77" value="pl_grayout_no" {if $css77 == pl_grayout_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="pl_quickview_style ver_270">
			<label class="options_title">{l s='Quick view style in the product-list:' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_qv_style_0"><input type="radio" name="angarconfig_input96" value="pl_qv_style_0" {if $css96 == pl_qv_style_0}checked{/if}>{l s='Style 0 - hide' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_qv_style_1"><input type="radio" name="angarconfig_input96" value="pl_qv_style_1" {if $css96 == pl_qv_style_1}checked{/if}>{l s='Style 1 - button center' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_qv_style_2"><input type="radio" name="angarconfig_input96" value="pl_qv_style_2" {if $css96 == pl_qv_style_2}checked{/if}>{l s='Style 2 - icon top' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_qv_style_3"><input type="radio" name="angarconfig_input96" value="pl_qv_style_3" {if $css96 == pl_qv_style_3}checked{/if}>{l s='Style 3 - icon bottom' mod='angarthemeconfigurator'}</label></br>
			<label class="pl_qv_style_4"><input type="radio" name="angarconfig_input96" value="pl_qv_style_4" {if $css96 == pl_qv_style_4}checked{/if}>{l s='Style 4 - button bottom' mod='angarthemeconfigurator'}</label>
		</div>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box15">{l s='Footer' mod='angarthemeconfigurator'}</div>
	<div id="customization_box15" class="collapse customization_container">
		...
		<div class="footer_links_style ver_270">
			...
			<label class="footer_links_style_1"><input type="radio" name="angarconfig_input97" value="footer_links_style_1" {if $css97 == footer_links_style_1}checked{/if}>{l s='Footer style 1 - default' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_links_style_2"><input type="radio" name="angarconfig_input97" value="footer_links_style_2" {if $css97 == footer_links_style_2}checked{/if}>{l s='Footer style 2 - simple' mod='angarthemeconfigurator'}</label></br>
		</div>

		<div class="footer_links_column ver_270">
			<label class="options_title">{l s='Footer style 2 - show links:' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_links_column_1"><input type="radio" name="angarconfig_input98" value="footer_links_column_1" {if $css98 == footer_links_column_1}checked{/if}>{l s='Show links from the column 1' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_links_column_2"><input type="radio" name="angarconfig_input98" value="footer_links_column_2" {if $css98 == footer_links_column_2}checked{/if}>{l s='Show links from the column 2' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_links_column_3"><input type="radio" name="angarconfig_input98" value="footer_links_column_3" {if $css98 == footer_links_column_3}checked{/if}>{l s='Show links from the column 3' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_links_column_4"><input type="radio" name="angarconfig_input98" value="footer_links_column_4" {if $css98 == footer_links_column_4}checked{/if}>{l s='Show links from the column 4' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_links_column_5"><input type="radio" name="angarconfig_input98" value="footer_links_column_5" {if $css98 == footer_links_column_5}checked{/if}>{l s='Show all links' mod='angarthemeconfigurator'}</label></br>
		</div>

		<div class="footer_social">
			<label class="options_title">{l s='Hide newsletter and social icons in the footer:' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_social_yes"><input type="radio" name="angarconfig_input99" value="footer_social_yes" {if $css99 == footer_social_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="footer_social_no"><input type="radio" name="angarconfig_input99" value="footer_social_no" {if $css99 == footer_social_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>
	...
	<div class="customization_title ver_270" data-toggle="collapse" data-parent="#accordion" data-target="#customization_box16">{l s='Product page' mod='angarthemeconfigurator'}</div>
...
*}
		...
		<div class="product_arrows ver_270">
			<label class="options_title">{l s='Hide gallery arrows:' mod='angarthemeconfigurator'}</label></br>
			<label class="prod_arrows_yes"><input type="radio" name="angarconfig_input100" value="prod_arrows_yes" {if $css100 == prod_arrows_yes}checked{/if}>{l s='Yes' mod='angarthemeconfigurator'}</label></br>
			<label class="prod_arrows_no"><input type="radio" name="angarconfig_input100" value="prod_arrows_no" {if $css100 == prod_arrows_no}checked{/if}>{l s='No' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="product_thumbnails ver_270">
			<label class="options_title">{l s='Show all thumbnails:' mod='angarthemeconfigurator'}</label></br>
			<label class="prod_thumb_style_1"><input type="radio" name="angarconfig_input101" value="prod_thumb_style_1" {if $css101 == prod_thumb_style_1}checked{/if}>{l s='Yes - display all thumbnails' mod='angarthemeconfigurator'}</label></br>
			<label class="prod_thumb_style_2"><input type="radio" name="angarconfig_input101" value="prod_thumb_style_2" {if $css101 == prod_thumb_style_2}checked{/if}>{l s='No - display carousel of thumbnails' mod='angarthemeconfigurator'}</label>
		</div>

		<div class="popup_thumbnails ver_270">
			<label class="options_title">{l s='Gallery popup thumbnails:' mod='angarthemeconfigurator'}</label></br>
			<label class="popup_thumb_style_1"><input type="radio" name="angarconfig_input102" value="popup_thumb_style_1" {if $css102 == popup_thumb_style_1}checked{/if}>{l s='Style 1 - Vertical' mod='angarthemeconfigurator'}</label></br>
			<label class="popup_thumb_style_2"><input type="radio" name="angarconfig_input102" value="popup_thumb_style_2" {if $css102 == popup_thumb_style_2}checked{/if}>{l s='Style 2 - Horizontal' mod='angarthemeconfigurator'}</label>
		</div>
...
{if $demo == 1}
	<input type="submit" value="{l s='Save' mod='angarthemeconfigurator'}" class="button_at_config" name="submitAngarConfig" />
...
<div class="theme_customization_header">{l s='Theme color editor' mod='angarthemeconfigurator'}</div>
...
<div class="panel">	
	...
	<div class="section_header">{l s='Predefined color schemes' mod='angarthemeconfigurator'}</div>

	<div class="customization_title" data-toggle="collapse" data-parent="#accordion2" data-target="#color_box00">{l s='Color schemes' mod='angarthemeconfigurator'}</div>
	<div id="color_box00" class="collapse customization_container">

	<div class="color_schemes">
		<label class="options_title">{l s='Color schemes:' mod='angarthemeconfigurator'}</label></br>

		<label class="color_scheme_at01"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at01" {if $color89 == color_scheme_at01}checked{/if}>{l s='AT01' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at02"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at02" {if $color89 == color_scheme_at02}checked{/if}>{l s='AT02' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at03"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at03" {if $color89 == color_scheme_at03}checked{/if}>{l s='AT03' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at04"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at04" {if $color89 == color_scheme_at04}checked{/if}>{l s='AT04' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at05"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at05" {if $color89 == color_scheme_at05}checked{/if}>{l s='AT05' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at06"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at06" {if $color89 == color_scheme_at06}checked{/if}>{l s='AT06' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at07"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at07" {if $color89 == color_scheme_at07}checked{/if}>{l s='AT07' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at08"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at08" {if $color89 == color_scheme_at08}checked{/if}>{l s='AT08' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at09"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at09" {if $color89 == color_scheme_at09}checked{/if}>{l s='AT09' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at10"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at10" {if $color89 == color_scheme_at10}checked{/if}>{l s='AT10' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at11"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at11" {if $color89 == color_scheme_at11}checked{/if}>{l s='AT11' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at12"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at12" {if $color89 == color_scheme_at12}checked{/if}>{l s='AT12' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at13"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at13" {if $color89 == color_scheme_at13}checked{/if}>{l s='AT13' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at14"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at14" {if $color89 == color_scheme_at14}checked{/if}>{l s='AT14' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at15"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at15" {if $color89 == color_scheme_at15}checked{/if}>{l s='AT15' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at16"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at16" {if $color89 == color_scheme_at16}checked{/if}>{l s='AT16' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at17"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at17" {if $color89 == color_scheme_at17}checked{/if}>{l s='AT17' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at18"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at18" {if $color89 == color_scheme_at18}checked{/if}>{l s='AT18' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at19"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at19" {if $color89 == color_scheme_at19}checked{/if}>{l s='AT19' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at20"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at20" {if $color89 == color_scheme_at20}checked{/if}>{l s='AT20' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
		<label class="color_scheme_at21"><span class="color_scheme_text"><input type="radio" name="angarcolor_input89" value="color_scheme_at21" {if $color89 == color_scheme_at21}checked{/if}>{l s='AT21' mod='angarthemeconfigurator'}</span> <span class="color_scheme_colors"><span class="c1"></span><span class="c2"></span><span class="c3"></span><span class="c4"></span></span></label>
	...
	<div class="section_header">{l s='Advanced color options' mod='angarthemeconfigurator'}</div>
...
*}
	...
	<div class="color_modyficator form-group search_color2">
		<label class="options_title">{l s='Search button' mod='angarthemeconfigurator'} - {l s='font color:' mod='angarthemeconfigurator'}</label></br>
		<input type="text" name="angarcolor_input90" id="search_button_color2" class="form-control" value="{$color90|escape:'htmlall':'UTF-8'}">
	</div>

	<div class="color_modyficator form-group search_color2">
		<label class="options_title">{l s='Search button' mod='angarthemeconfigurator'} - {l s='font color hover:' mod='angarthemeconfigurator'}</label></br>
		<input type="text" name="angarcolor_input91" id="search_button_color_hover2" class="form-control" value="{$color91|escape:'htmlall':'UTF-8'}">
	</div>
	...
	<div class="color_modyficator form-group cart_color2">
		<label class="options_title">{l s='Cart' mod='angarthemeconfigurator'} - {l s='font color 2:' mod='angarthemeconfigurator'}</label></br>
		<input type="text" name="angarcolor_input92" id="cart_color2" class="form-control" value="{$color92|escape:'htmlall':'UTF-8'}">
	</div>

	<div class="color_modyficator form-group cart_color2 cart_background2">
		<label class="options_title">{l s='Cart' mod='angarthemeconfigurator'} - {l s='background 2:' mod='angarthemeconfigurator'}</label></br>
		<input type="text" name="angarcolor_input93" id="cart_background2" class="form-control" value="{$color93|escape:'htmlall':'UTF-8'}">
	</div>
...
*}
	...
	<div class="color_modyficator form-group">
		<label class="options_title">{l s='New labels' mod='angarthemeconfigurator'} - {l s='background:' mod='angarthemeconfigurator'}</label></br>
		<input type="text" name="angarcolor_input20" id="new_label" class="form-control" value="{$color20|escape:'htmlall':'UTF-8'}">
	</div>

	<div class="color_modyficator form-group">
		<label class="options_title">{l s='Discount labels' mod='angarthemeconfigurator'} - {l s='background:' mod='angarthemeconfigurator'}</label></br>
		<input type="text" name="angarcolor_input94" id="discount_label" class="form-control" value="{$color94|escape:'htmlall':'UTF-8'}">
	</div>
	...
	<div class="color_modyficator form-group">
		<label class="options_title">{l s='Price color in the product-list:' mod='angarthemeconfigurator'}</label></br>
