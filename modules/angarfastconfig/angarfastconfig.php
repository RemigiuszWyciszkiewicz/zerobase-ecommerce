...
class AngarFastconfig extends Module
{
    ...
    public $tabs = [
        [
            'name' => 'AngarTheme configuration',
            'class_name' => 'AdminAngarFastconfig',
            'visible' => true,
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->displayName = $this->l('AT - Fast configuration of the modules');
        $this->description = $this->l('Start configuration here! Configure the main modules of the theme.');
    ...
    public function installTab()
    {
        foreach ($this->tabs as $tab) {
            ...
            foreach (Language::getLanguages(true) as $lang) {
                $tab_inst->name[$lang['id_lang']] = $tab['name'];
            }
            $tab_inst->class_name = $tab['class_name'];
            $tab_inst->id_parent = $id_parent;
            $tab_inst->module = $this->name;
			$tab_inst->icon = 'tune';
            $tab_inst->active = (bool) $tab['visible'];
            if (!$tab_inst->add()) {
                return false;
            }
        }
    ...
    public function renderConfigurationForm()
    {
        ...
        $fields_form = array(
            'form' => array(
                ...
                'description' => $this->l('If you need help with theme configuration, please send me a message on addons.prestashop.com here: https://addons.prestashop.com/en/contact-us?id_product=30887').'<br/>'.
